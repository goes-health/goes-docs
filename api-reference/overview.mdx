...
Get a comprehensive overview of all risks and alerts for a location, combining environmental risks, wildlife risks, plant risks, and national weather alerts. Available in two formats: a simple cacheable GET request for quick checks, or an advanced POST request with full customization options.

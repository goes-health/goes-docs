...
<ParamField body="options" type="object">
  ...
  <Expandable title="options properties">
    ...
    <ParamField body="options.exclude" type="array">
      ...
      - `summary`: Excludes the AI-generated summary for each hour
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="profile" type="object">
  ...
  <Expandable title="profile properties">
    <ParamField body="profile.activity" type="string">
      The outdoor activity you plan to do (e.g., "hiking", "camping", "skiing"). This helps personalize the hourly forecast summaries.
    </ParamField>
    
    <ParamField body="profile.age" type="integer">
      The age of the person doing the activity. Used to provide age-appropriate risk analysis in the hourly summaries.
    </ParamField>
    ...
    <ParamField body="profile.context" type="string">
      Any additional context that may be relevant for the forecast. This helps provide more personalized recommendations for each hour.
    </ParamField>
  </Expandable>
</ParamField>
...
Both the GET and POST methods return the same response format. The POST method provides more personalized content in the summary field for each hourly forecast entry.
...
<ResponseField name="forecast" type="array">
  ...
  <Expandable title="child attributes">
    ...
    <ResponseField name="summary" type="string">
      AI-generated summary paragraph for this hour, personalized to your activity and experience level when using the POST method.
    </ResponseField>
  ...
  "forecast": [
    {
      ...
      "summary": "For your backpacking trip, early morning conditions are ideal with low UV and minimal lightning risk. This is the perfect time to break camp and start your hike before temperatures rise.",
      "risks": [
        {
          "id": "sunburn",
          "title": "Sunburn",

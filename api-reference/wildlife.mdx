...
<ParamField query="ids" type="string">
  A comma-separated list of wildlife risk IDs to check. If you do not provide this, all risks will be checked.
...
<ResponseField name="risks" type="array">
  ...
  <ResponseField name="score" type="number">
    A number from 0-4 representing the prevalence of this wildlife in the area:
    - 0: None
    - 1: Low
    - 2: Medium
    - 3: High
...
```bash
curl "http://api.goes.health/v1/wildlife?ids=bears,venomous-snakes&location=34.0522,-118.2437&api_key=YOUR_API_KEY"
```

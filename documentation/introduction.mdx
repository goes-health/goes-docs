...
<CardGroup cols={3}>
  ...
  <Card title="Environmental Forecast">
    Use for 48-hour, hour-by-hour environmental risk forecasts to plan ahead.
  ...
  <Card title="Overview Forecast">
    Use for comprehensive 48-hour forecasts with all risks, alerts, and AI-generated insights.
